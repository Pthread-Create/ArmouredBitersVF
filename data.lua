...
small_armoured_tint1 = {r = 0.93, g = 0.94, b = 0.72, a = .6}
small_armoured_tint2 = {r = 0.9, g = 0.83, b = 0.54, a = 1}

medium_armoured_scale = 0.65
medium_armoured_tint1 = {r = 0.49, g = 0.46, b = 0.51, a = 0.8}
medium_armoured_tint2 = {r = 0.93, g = 0.72, b = 0.72, a = 1}

big_armoured_scale = 0.8
big_armoured_tint1 = {r = 0.53, g = 0.65, b = 0.90, a = 0.8}
big_armoured_tint2 = {r = 0.56, g = 0.54, b = 0.98, a = 1}

behemoth_armoured_scale = 1
behemoth_armoured_tint1 = {r = 0.41, g = 0.63, b = 0.40, a = 1}
behemoth_armoured_tint2 = {r = 0.44, g = 1, b = 0.29, a = 1}
...
data:extend({
    {
        ...
        icon_size = 32,
        flags = {
            "placeable-player", "placeable-enemy", "placeable-off-grid",
            "breaths-air", "not-repairable"
        },
        max_health = 50 *
            setting_utils.getPositivePercentageOf(
                "ab-small-armoured-biter-health"),
        subgroup = "enemies",
        resistances = {
            {
                type = "physical",
                decrease = 1 *
                    setting_utils.getPositivePercentageOf(
                        "ab-small-armoured-biter-resistances"),
                percent = 10 *
                    setting_utils.getPositivePercentageOf(
                        "ab-small-armoured-biter-resistances")
            }, {
        ...
        attack_parameters = {
            ...
            animation = armoredAttackBiter(small_armoured_scale,
        ...
        run_animation = armoredRunBiter(small_armoured_scale,
                                        small_armoured_tint1,
                                        small_armoured_tint2),
        ...
        damaged_trigger_effect = table.deepcopy(
            data.raw['unit']['small-biter'].damaged_trigger_effect)
    },
    add_biter_armoured_die_animation(small_armoured_scale, small_armoured_tint1,
                                     small_armoured_tint2, {
        type = "corpse",
        ...
        flags = {
            ...
            "building-direction-8-way", "not-repairable", "not-on-map"
        }
    }), {
        type = "unit",
        ...
        max_health = 200 *
            setting_utils.getPositivePercentageOf(
                "ab-medium-armoured-biter-health"),
        subgroup = "enemies",
        resistances = {
            {
                type = "physical",
                decrease = 4 *
                    setting_utils.getPositivePercentageOf(
                        "ab-medium-armoured-biter-resistances"),
                percent = 20 *
                    setting_utils.getPositivePercentageOf(
                        "ab-medium-armoured-biter-resistances")
            }, {
        ...
        attack_parameters = {
            ...
            animation = armoredAttackBiter(medium_armoured_scale,
        ...
        working_sound = sounds.biter_calls(0.4),
        dying_sound = sounds.biter_dying(0.9),
        run_animation = armoredRunBiter(medium_armoured_scale,
                                        medium_armoured_tint1,
                                        medium_armoured_tint2),
        ai_settings = biter_ai_settings,
        ...
        running_sound_animation_positions = {2},
        damaged_trigger_effect = table.deepcopy(
            data.raw['unit']['medium-biter'].damaged_trigger_effect)
    },
    add_biter_armoured_die_animation(medium_armoured_scale,
                                     medium_armoured_tint1,
                                     medium_armoured_tint2, {
        type = "corpse",
        ...
        max_health = 800 *
            setting_utils.getPositivePercentageOf("ab-big-armoured-biter-health"),
        subgroup = "enemies",
        resistances = {
            {
                type = "physical",
                decrease = 8 *
                    setting_utils.getPositivePercentageOf(
                        "ab-big-armoured-biter-resistances"),
                percent = 20 *
                    setting_utils.getPositivePercentageOf(
                        "ab-big-armoured-biter-resistances")
            }, {
        ...
        attack_parameters = {
            ...
            animation = armoredAttackBiter(big_armoured_scale,
                                           big_armoured_tint1,
                                           big_armoured_tint2)
        },
        vision_distance = 30,
        ...
        run_animation = armoredRunBiter(big_armoured_scale, big_armoured_tint1,
                                        big_armoured_tint2),
        ai_settings = biter_ai_settings,
        walking_sound = sounds.biter_walk_big(0.4),
        running_sound_animation_positions = {2},
        damaged_trigger_effect = table.deepcopy(
            data.raw['unit']['big-biter'].damaged_trigger_effect)
    }, add_biter_armoured_die_animation(big_armoured_scale, big_armoured_tint1,
                                        big_armoured_tint2, {
        type = "corpse",
        ...
        max_health = 6000 *
            setting_utils.getPositivePercentageOf(
                "ab-behemoth-armoured-biter-health"),
        subgroup = "enemies",
        resistances = {
            {
                type = "physical",
                decrease = 12 *
                    setting_utils.getPositivePercentageOf(
                        "ab-behemoth-armoured-biter-resistances"),
                percent = 25 *
                    setting_utils.getPositivePercentageOf(
                        "ab-behemoth-armoured-biter-resistances")
            }, {
        ...
        attack_parameters = {
            ...
            animation = armoredAttackBiter(behemoth_armoured_scale,
        ...
        working_sound = sounds.biter_calls_big(0.4),
        dying_sound = sounds.biter_dying_big(0.9),
        run_animation = armoredRunBiter(behemoth_armoured_scale,
                                        behemoth_armoured_tint1,
                                        behemoth_armoured_tint2),
        ai_settings = biter_ai_settings,
        ...
        running_sound_animation_positions = {2},
        damaged_trigger_effect = table.deepcopy(
            data.raw['unit']['behemoth-biter'].damaged_trigger_effect)

    }, add_biter_armoured_die_animation(behemoth_armoured_scale,
                                        behemoth_armoured_tint1,
                                        behemoth_armoured_tint2, {
        type = "corpse",
...
local s_r = setting_utils.getPositivePercentageOf(
                "ab-small-armoured-biter-spawn-probability")
local m_r = setting_utils.getPositivePercentageOf(
                "ab-medium-armoured-biter-spawn-probability")
local b_r = setting_utils.getPositivePercentageOf(
                "ab-big-armoured-biter-spawn-probability")
local bb_r = setting_utils.getPositivePercentageOf(
                 "ab-behemoth-armoured-biter-spawn-probability")
local l_r = setting_utils.getPositivePercentageOf(
                "ab-leviathan-armoured-biter-spawn-probability")

local result_units = {
    {"small-armoured-biter", {{0.0, 0.3 * s_r}, {0.6, 0.0}}},
    {"medium-armoured-biter", {{0.2, 0.0}, {0.6, 0.3 * m_r}, {0.7, 0.1 * m_r}}},
    {"big-armoured-biter", {{0.5, 0.0}, {1.0, 0.4 * b_r}}},
    {"behemoth-armoured-biter", {{0.9, 0.0}, {1.0, 0.3 * bb_r}}}
}

local res_mp = setting_utils.getPositivePercentageOf(
                   "ab-leviathan-armoured-biter-resistances")
local leviathan_resists = {
    {type = "physical", decrease = 12 * res_mp, percent = 25 * res_mp},
    {type = "explosion", decrease = 12 * res_mp, percent = 25 * res_mp},
    {type = "laser", decrease = 10 * res_mp, percent = 20 * res_mp},
    {type = "impact", decrease = 20 * res_mp, percent = 40 * res_mp},

    {type = "fire", decrease = 4 * res_mp, percent = 40 * res_mp}
}

local leviathan_scale = 1.25
local leviathan_tint1 = {r = 0.9, g = 0.23, b = 0.23, a = 0.95}
local leviathan_tint2 = {r = 0.78, g = 0.84, b = 0, a = 0.9}

if l_r > 0 then
    table.insert(result_units, {
        "leviathan-armoured-biter", {{0.965, 0.0}, {1.0, 0.06 * l_r}}
    })
    ...
    data:extend({

        {
            ...
            max_health = 18000 *
                setting_utils.getPositivePercentageOf(
                    "ab-leviathan-armoured-biter-health"),
            subgroup = "enemies",
            ...
            attack_parameters = {
                ...
                animation = armoredAttackBiter(leviathan_scale, leviathan_tint1,
                                               leviathan_tint2),
                ammo_type = {
                    category = "melee",
                    target_type = "entity",
            ...
            damaged_trigger_effect = table.deepcopy(
                data.raw['unit']['behemoth-biter'].damaged_trigger_effect),
            run_animation = armoredRunBiter(leviathan_scale, leviathan_tint1,
                                            leviathan_tint2),
            ai_settings = biter_ai_settings
        }, add_biter_armoured_die_animation(leviathan_scale, leviathan_tint1,
                                            leviathan_tint2, {
            type = "corpse",
...
if settings.startup["ab-enable-nest"].value then
    ...
    local nest_tint = {r = 0.36, g = 0.98, b = 0.38, a = 1}
    ...
    data:extend({
        {
            ...
            ground_patch = {sheet = spawner_integration()}
        }
    })
    ...
    if biterSpawner then
        ...
        unitSet[#unitSet + 1] = {
            ...
            {{0.2, 0.0}, {0.6, 0.3 * m_r}, {0.7, 0.1 * m_r}}
        }
        unitSet[#unitSet + 1] = {
            "big-armoured-biter", {{0.5, 0.0}, {1.0, 0.4 * b_r}}
        }
