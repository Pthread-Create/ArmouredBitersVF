...
data:extend({
		...
		add_biter_armoured_die_animation(small_armoured_scale, small_armoured_tint1, small_armoured_tint2,
		{
			type = "corpse",
		...
		add_biter_armoured_die_animation(medium_armoured_scale, medium_armoured_tint1, medium_armoured_tint2,
		{
			type = "corpse",
		...
		add_biter_armoured_die_animation(big_armoured_scale, big_armoured_tint1, big_armoured_tint2,
		{
			type = "corpse",
            ...
            attack_parameters =
                {
                    ...
                    animation = armoredAttackBiter(behemoth_armoured_scale, behemoth_armoured_tint1, behemoth_armoured_tint2),
										ammo_type = {
							  category = "melee",
							  target_type = "entity",
								action = {
		...
		add_biter_armoured_die_animation(behemoth_armoured_scale, behemoth_armoured_tint1, behemoth_armoured_tint2,
		{
			type = "corpse",
...
if l_r>0 then 
table.insert (result_units,  {"leviathan-armoured-biter", {{0.965, 0.0}, {1.0, 0.06 *l_r}}})
...
data:extend({	
		...
		add_biter_armoured_die_animation(leviathan_scale, leviathan_tint1, leviathan_tint2,
		{
			type = "corpse",
...
else ab_enemy_autoplace = ab_enemy_autoplace.enemy_spawner_autoplace(0) 
	end
...
data:extend({ 
...

  {
	...
	if biterSpawner then
		...
		unitSet[#unitSet+1] = {"small-armoured-biter", {{0.0, 0.3*s_r}, {0.6, 0.0}}}
		unitSet[#unitSet+1] = {"medium-armoured-biter", {{0.2, 0.0}, {0.6, 0.3*m_r}, {0.7, 0.1*m_r}}}
		unitSet[#unitSet+1] = {"big-armoured-biter", {{0.5, 0.0}, {1.0, 0.4*b_r}}}
		unitSet[#unitSet+1] = {"behemoth-armoured-biter", {{0.9, 0.0}, {1.0, 0.3*bb_r}}}
		
		if l_r>0 then 
			unitSet[#unitSet+1] = {"leviathan-armoured-biter", {{0.965, 0.0}, {1.0, 0.06 *l_r}}}
			end
	end
