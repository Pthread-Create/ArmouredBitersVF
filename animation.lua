function add_biter_armoured_die_animation(scale, tint1, tint2, corpse)
    ...
    corpse.ground_patch_fade_out_start = 1 * 60
    corpse.ground_patch_fade_out_duration = 60 * 60
...
function armoured_spawner_idle_animation(variation, tint)
    return {
        layers = {
            {
                filename = "__ArmouredBiters__/graphics/armoured-spawner/spawner-armoured-idle.png",
                line_length = 4,
                width = 490,
                height = 354,
                frame_count = 8,
            ...
            {
                filename = "__ArmouredBiters__/graphics/armoured-spawner/spawner-armoured-idle-mask.png",
                flags = {"mask"},
                width = 276,
                height = 235,
                frame_count = 8,
            ...
            {
                filename = "__ArmouredBiters__/graphics/armoured-spawner/spawner-armoured-idle-shadow.png",
                draw_as_shadow = true,
                width = 464,
                height = 406,
                frame_count = 8,
...
function spawner_armoured_integration()
    return {
        filename = "__ArmouredBiters__/graphics/armoured-spawner/spawner-armoured-idle-integration.png",
        variation_count = 1,
        width = 522,
        height = 380,
